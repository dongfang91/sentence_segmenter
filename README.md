...
The `collect_notes_from_mimic.py` Python script is designed to retrieve clinical notes from the MIMIC-III clinical database. The script takes a text file containing note IDs, and return the raw clinical notes we used for this task.
